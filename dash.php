...
<tbody>
	...
	function getLastResults($table, $testType, $product, $job, $Branch) {
		...
		$sqlTestsList = $conn->query($query);

		if ($sqlTestsList !== false && $sqlTestsList->num_rows > 0) {
			$passed = 0;
			$failed = 0;
			$analyse = 0;
			...
			$runn="https://sqs-sel-cent1.cas-software.dev/logs/dailyStats.php?passed=".$passed."&failed=".$failed."&percent=".$failedPercentage."&Branch=".urlencode($Branch)."&table=".$table."_daily&analyse=".$analyse;
	...
	*/
	...
	if(isItTimeToGetLastRuns() || $refresh == "true"){	
		...
		*/
		...
		$url="https://sqs-sel-cent1.cas-software.dev/logs/dash.php";
		$content = file_get_contents($url,false, $streamContext);	
		//header("Location: " . $url);
	}	
	?>
	<center>
	<br><a href="https://sqs-sel-cent1.cas-software.dev/logs/index.php"><< UI-TESTS STATUS Summary</a><br><br>
	</center>	
    <table class="tg">
		<thead>
		  <tr >
			<?php	
			echo "<th class=\"tg-simple1\"><a href=\"https://sqs-sel-cent1.cas-software.dev/logs/dash.php?refresh=true\" style=\"display:block;\"><img title=\"Refresh results\" src=\"icons\\refresh.png\"><br>Reload</a></th>";  
			...
			for ($row = 1; $row <= 4; $row++) {
				echo '<tr>';
					...
					if ($row == 3) {
						...
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_hf&Filter=yes&Testtype=we_hf&Product=weWebSel&tag=", $we_hf_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_rc&Filter=yes&Testtype=we_rc&Product=weWebSel&tag=", $we_rc_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_dev&Filter=yes&Testtype=we_dev&Product=weWebSel&tag=", $we_dev_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x16_hf&Filter=yes&Testtype=hf_x16&Product=gWWebSel&tag=", $web_hf12_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x16_rc&Filter=yes&Testtype=rc_x16&Product=gWWebSel&tag=", $web_rc12_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x16_dev&Filter=yes&Testtype=dev_x16&Product=gWWebSel&tag=", $web_dev12_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x17_hf&Filter=yes&Testtype=hf_x17&Product=gWWebSel&tag=", $web_hf13_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x17_rc&Filter=yes&Testtype=rc_x17&Product=gWWebSel&tag=", $web_rc13_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x17_dev&Filter=yes&Testtype=dev_x17&Product=gWWebSel&tag=", $web_dev13_failed);
						//generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x18_hf&Filter=yes&Testtype=hf_x18&Product=gWWebSel&tag=", $web_hf14_failed);
						//generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x18_rc&Filter=yes&Testtype=rc_x18&Product=gWWebSel&tag=", $web_rc14_failed);
						generateResultCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x18_dev&Filter=yes&Testtype=dev_x18&Product=gWWebSel&tag=", $web_dev14_failed);
						/*echo "<td class=\"tg-disabled\">0</td>";
						echo "<td class=\"tg-disabled\">0</td>";
						echo "<td class=\"tg-disabled\">0</td>";
						echo "<td class=\"tg-disabled\">0</td>";*/
					...
					if ($row == 4) {
						...
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_hf&Filter=yes&Testtype=we_hf&Product=weWebSel&tag=", $we_hf_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_rc&Filter=yes&Testtype=we_rc&Product=weWebSel&tag=", $we_rc_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_dev&Filter=yes&Testtype=we_dev&Product=weWebSel&tag=", $we_dev_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x16_hf&Filter=yes&Testtype=hf_x16&Product=gWWebSel&tag=", $web_hf12_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x16_rc&Filter=yes&Testtype=rc_x16&Product=gWWebSel&tag=", $web_rc12_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x16_dev&Filter=yes&Testtype=dev_x16&Product=gWWebSel&tag=", $web_dev12_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x17_hf&Filter=yes&Testtype=hf_x17&Product=gWWebSel&tag=", $web_hf13_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x17_rc&Filter=yes&Testtype=rc_x17&Product=gWWebSel&tag=", $web_rc13_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x17_dev&Filter=yes&Testtype=dev_x17&Product=gWWebSel&tag=", $web_dev13_analyse);
						//generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x18_hf&Filter=yes&Testtype=hf_x18&Product=gWWebSel&tag=", $web_hf14_analyse);
						//generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x18_rc&Filter=yes&Testtype=rc_x18&Product=gWWebSel&tag=", $web_rc14_analyse);
						generateAnalyseCell("https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=x18_dev&Filter=yes&Testtype=dev_x18&Product=gWWebSel&tag=", $web_dev14_analyse);
						/*echo "<td class=\"tg-disabled\">0</td>";
						echo "<td class=\"tg-disabled\">0</td>";
						echo "<td class=\"tg-disabled\">0</td>";
						echo "<td class=\"tg-disabled\">0</td>";	*/					
