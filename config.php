        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped align-middle text-center">
            <thead class="table-light">
              <tr>
                <th>Branch (<a href="https://sqs-sel-cent1.cas-software.dev/logs/index.php" target="_blank">Logs</a>)</th>
                <?php
      ...
      <div class="tab-pane fade" id="smartwe" role="tabpanel" aria-labelledby="smartwe-tab">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped align-middle text-center">
            <thead class="table-light">
              <tr>
                <th>Branch (<a href="https://sqs-sel-cent1.cas-software.dev/logs/index.php?LogVersion=we_dev&Testtype=we_dev&Product=weWebSel&TestBrowser=chrome" target="_blank">Logs</a>)</th>
                <?php
                foreach ($branches as $branch) {
					if ($branch === 'wehf') {
